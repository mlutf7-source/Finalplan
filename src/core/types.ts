                                                                                                                  ...
                                                                                                                  id: string;
                                                                                                                    position: Point;
                                                                                                                      rotation: number;
                                                                                                                        ...
                                                                                                                        // ✅ إضافة نوع إطار الكليشة (نسبة A3)
                                                                                                                        export interface ClipFrame {
                                                                                                                          id: string;
                                                                                                                            x: number; // مركز الإطار في العالم
                                                                                                                              y: number;
                                                                                                                                width: number; // عرض الإطار (يرتبط بنسبة A3)
                                                                                                                                  height: number; // طول الإطار (نسبة 1:1.414)
                                                                                                                                                    ...
                                                                                                                                                    zoom: number;
                                                                                                                                                      offsetX: number;
                                                                                                                                                        ...
                                                                                                                                                        export interface CalculationResults {
                                                                                                                                                          buildingArea: number;
                                                                                                                                                            exteriorWallsLength: number;
                                                                                                                                                              interiorWallsLength: number;
                                                                                                                                                                exteriorWallsArea: number;
                                                                                                                                                                  interiorWallsArea: number;
                                                                                                                                                                    columnsArea: number;
                                                                                                                                                                      windowsArea: number;
                                                                                                                                                                        doorsArea: number;
                                                                                                                                                                          netExteriorWallsArea: number;
                                                                                                                                                                            netInteriorWallsArea: number;
                                                                                                                                                                            }
                                                                                                                                                                                                          ...
                                                                                                                                                                                                          riserHeight: 0.17,
                                                                                                                                                                                                            ...
                                                                                                                                                                                                            export const DEFAULT_NORTH_ARROW = {
                                                                                                                                                                                                              size: 30,
                                                                                                                                                                                                                ...
                                                                                                                                                                                                                // ✅ إضافة القيمة الافتراضية لإطار الكليشة
                                                                                                                                                                                                                export const DEFAULT_CLIP_FRAME = {
                                                                                                                                                                                                                  width: 6,
                                                                                                                                                                                                                    height: 6 * 1.414, // نسبة A3 (1:1.414)
                                                                                                                                                                                                                      rotation: 0,
                                                                                                                                                                                                                      };
