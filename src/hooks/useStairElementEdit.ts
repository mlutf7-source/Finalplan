...
const SNAP_TOL = 0.15;
// ✅ أدنى مسافة حركة قبل تفعيل Snap (لمنع القفز عند اللمس)
const SNAP_MIN_MOVE = 0.05;
...
if (mode === 'rotate') {
      ...
      // ✅ لا تفعّل Snap إلا بعد حركة كافية
      const movedDist = Math.hypot(dx, dy);
      if (movedDist > SNAP_MIN_MOVE) {
